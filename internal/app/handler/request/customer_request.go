...
type CreateCustomerRequest struct {
	Name    string `form:"name" validate:"required,min=3,max=255" example:"Fajar Agus" binding:"required"`
	Email   string `form:"email" validate:"required,email" example:"fajar@gmail.com" binding:"required"`
	Address string `form:"address"  validate:"required,min=5" example:"Jl. Raya" binding:"required"`
}
